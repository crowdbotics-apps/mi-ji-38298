"""
Django settings for mi_ji_38298 project.
...
WSGI_APPLICATION = 'mi_ji_38298.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mi_ji_38298 API",
    "DESCRIPTION": "API documentation for mi_ji_38298 App",
    "VERSION": "v1",
}
